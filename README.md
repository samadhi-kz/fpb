...
- Share plays with links, export long book links as opener HTML or URL text files, and export plays as PDF
...
- Export behavior depends on the browser: links use clipboard/share support, long book links can be saved or shared as HTML opener or URL text files, and PDF uses the browser print dialog.
...
2. Open `index.html` locally in a desktop browser and verify:
   ...
   - link sharing, long Book Link HTML/TXT export, and PDF export functions open correctly
